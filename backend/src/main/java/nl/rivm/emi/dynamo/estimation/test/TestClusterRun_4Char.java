...
// 20100412			p.estimateModelParameters(100, i, null);
			...
			s.manufactureSimulationConfigurationFile(p, "data/development" + "\\population.XML");
	...
	@Test
	public void runFullSimulation() throws CDMRunException {
	...
	//		E2.writeInitialPopulation(p, 10, simName, 1111, false, null);
			...
			if (simulationConfigurationFile.exists()) {
				...
				log.fatal("4 characteristic run complete. Time used: "
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(TestClusterRun_4Char.class);
	}
}
