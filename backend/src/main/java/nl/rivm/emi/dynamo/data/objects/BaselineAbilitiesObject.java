...
public class BaselineAbilitiesObject  extends TypedHashMap<Age> implements StandardObjectMarker{
	/**
	 * 
	 */
	 ...
	 */
		public BaselineAbilitiesObject(TypedHashMap<Age> manufacturedMap) {
