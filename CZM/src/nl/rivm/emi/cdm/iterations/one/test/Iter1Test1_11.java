...
public class Iter1Test1_11 {
	...
	static public class UpdateRuleST1_01 extends
			AbstractDoubleBoundOneToOneUpdateRule {
	...
	static public class UpdateRuleST1_02 extends
			AbstractDoubleBoundOneToOneUpdateRule {
	...
	static public class UpdateRuleST1_03 extends
			AbstractDoubleBoundOneToOneUpdateRule {
	...
	static public class UpdateRuleST1_04 extends
			AbstractDoubleBoundOneToOneUpdateRule {
	...
	static public class UpdateRuleST1_05 extends
			AbstractDoubleBoundOneToOneUpdateRule {
	...
	static public class UpdateRuleST1_06 extends
			AbstractDoubleBoundOneToOneUpdateRule {
	...
	static public class UpdateRuleST1_07 extends
			AbstractDoubleBoundOneToOneUpdateRule {
	...
	static public class UpdateRuleST1_08 extends
			AbstractDoubleBoundOneToOneUpdateRule {
	...
	static public class UpdateRuleST1_09 extends
			AbstractDoubleBoundOneToOneUpdateRule {
		...
		public Object update(Object currentValue) {
			int currentIntValue = ((Integer) currentValue).intValue();
			int newValue = currentIntValue * currentIntValue;
			if (newValue > 10) {
				newValue = 10;
			}
			return newValue;
	...
	static public class UpdateRuleST1_10 extends
			AbstractDoubleBoundOneToOneUpdateRule {
		...
		public Object update(Object currentValue) {
			int currentIntValue = ((Integer) currentValue).intValue();
			int newValue = currentIntValue - 1;
			if (newValue < 1) {
				newValue = 1;
			}
			return newValue;
	...
	public void runLongitudinalSimulation() {
		...
		CharacteristicsConfigurationMapSingleton charConfMap = CharacteristicsConfigurationMapSingleton
				.getInstance();
		...
		Characteristic characteristic10 = new Characteristic(10,
				"Tweede ziekte");
		...
		try {
			...
			Population population = domBoot.process2PopulationTree(testpop,
					numberOfSteps);
	...
	public void runTransversalSimulation() {
		...
		try {
			...
			DOMPopulationWriter.writeToXMLFile(simulation.getPopulation(), 5,
					transSimOutputStep5);
