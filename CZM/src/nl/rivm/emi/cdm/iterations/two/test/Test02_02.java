...
public class Test02_02 {
	...
	String preCharConfig = "C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/charconf02_02.xml";

	File simulationConfigurationFile = new File(
			"C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/simulation02_02.xml");

	File simOutput = new File(
			"C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/sim02_02_out.xml");
//
//	String multiChar_Report_FileName = "C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/charconf02_02.txt";
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(
				nl.rivm.emi.cdm.iterations.two.test.Test02_02.class);
	}
}