...
public class Test02_10_100k {
	...
	File simulationConfigurationFile = new File(
			"C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/simulation02_10_100k.xml");

	File simOutput = new File(
			"C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/sim02_10_100k_out.xml");
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(
				nl.rivm.emi.cdm.iterations.two.test.Test02_10_100k.class);
	}
}