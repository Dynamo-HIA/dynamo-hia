...
public class UpdateRule02_05 extends ManyToOneUpdateRuleBase implements
		CharacteristicSpecific, StepSizeSpecific, NeedsSeed {

	Log log = LogFactory.getLog(this.getClass().getName());

	int characteristicId = 3;
