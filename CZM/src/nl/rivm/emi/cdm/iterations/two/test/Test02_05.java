...
public class Test02_05 {
	...
	String preCharConfig = "C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/charconf02_05.xml";

	File simulationConfigurationFile = new File(
			"C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/simulation02_05.xml");

	File simOutput = new File(
			"C:/eclipse321/workspace/CZM/unittestdata/iteration2/test/sim02_05_out.xml");
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(
				nl.rivm.emi.cdm.iterations.two.test.Test02_05.class);
	}
}