 ...
 * 
 */
public class RelRiskForAbilityBeginModal extends AgnosticModal {
	 ...
	 * @param selectedNode
	 */
	public RelRiskForAbilityBeginModal(Shell parentShell,
	...
	protected String createCaption(BaseNode selectedNode2) {
		return "Begin Relative Risk for ability in duration class";
	}
