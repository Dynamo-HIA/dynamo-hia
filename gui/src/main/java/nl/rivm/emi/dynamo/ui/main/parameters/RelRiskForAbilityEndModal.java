 ...
 * 
 */
public class RelRiskForAbilityEndModal extends AgnosticModal {
	 ...
	 * @param selectedNode
	 */
	public RelRiskForAbilityEndModal(Shell parentShell,
	...
	protected String createCaption(BaseNode selectedNode2) {
		return "End Relative Risk for ability in durationclass";
	}
