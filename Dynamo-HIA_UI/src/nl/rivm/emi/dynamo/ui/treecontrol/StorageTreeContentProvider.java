...
public class StorageTreeContentProvider implements ITreeContentProvider {
	...
	public StorageTreeContentProvider(RootNode rootNode) throws StorageTreeException{
		if(rootNode != null){
			this.rootNode = rootNode;
		} else {
			throw new StorageTreeException("Content provider requires a non null StorageTree reference.");
	}
	}
	
		public Object[] getElements(Object inputElement) {
			return ((ParentNode)inputElement).getChildren();
//			Object[] elements = {inputElement};
//			return elements;
				}
