 ...
 * File Viewer example
 */
public class SimpleFileTreeViewer { 
	...
	private final String[] tableTitles = new String [] {
		SimpleFileTreeViewer.getResourceString("table.Name.title"),
		SimpleFileTreeViewer.getResourceString("table.Size.title"),
		SimpleFileTreeViewer.getResourceString("table.Type.title"),
		SimpleFileTreeViewer.getResourceString("table.Modified.title")
	};
	private Table table;
	...
	private void createTreeView(Composite parent) {
		...
		treeScopeLabel.setText(SimpleFileTreeViewer.getResourceString("details.AllFolders.text"));
	...
	private void treeRefreshItem(TreeItem dirItem, boolean forcePopulate) {
		...
		File[] subFiles = (dir != null) ? SimpleFileTreeViewer.getDirectoryList(dir) : null;
...
//		if (bIsDir && ! aIsDir) return 1;
	...
	private void workerExecute() {
		...
		display.syncExec(new Runnable() {
			public void run() {
				tableContentsOfLabel.setText(SimpleFileTreeViewer.getResourceString("details.ContentsOf.text",
