...
public class TestLists {
	...
	public void ageGenderList() {
		AgeGenderRow[] rows = { new AgeGenderRow(0F, 1F, 2F),
				new AgeGenderRow(1F, 2F, 3F), new AgeGenderRow(2F, 3F, 4F),
				new AgeGenderRow(3F, 4F, 5F), new AgeGenderRow(4F, 5F, 6F),
				new AgeGenderRow(5F, 6F, 7F), new AgeGenderRow(6F, 7F, 8F),
				new AgeGenderRow(7F, 8F, 9F) };
