...
public class DiseaseIncidencesModal implements Runnable, DataAndFileContainer {
	...
	public DiseaseIncidencesModal(Shell parentShell, String configurationFilePath,
	...
	public synchronized void open() {
		try {
			...
			diseaseIncidencesGroup.setFormData(helpPanel.getGroup(), buttonPanel);
			shell.pack();
