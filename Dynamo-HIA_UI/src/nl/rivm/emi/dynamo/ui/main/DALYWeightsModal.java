...
public class DALYWeightsModal implements Runnable, DataAndFileContainer {
	...
	public DALYWeightsModal(Shell parentShell, String configurationFilePath,
		...
		shell = new Shell(parentShell, SWT.DIALOG_TRIM | SWT.PRIMARY_MODAL
				| SWT.RESIZE);
		shell.setText(createCaption((BaseNode)((ChildNode)selectedNode).getParent()));
	...
	public synchronized void open() {
		try {
			...
			dalyWeightsGroup.setFormData(helpPanel.getGroup(), buttonPanel);
			shell.pack();
