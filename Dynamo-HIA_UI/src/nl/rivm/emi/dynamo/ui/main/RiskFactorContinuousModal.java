...
public class RiskFactorContinuousModal implements Runnable, DataAndFileContainer {
	...
	public RiskFactorContinuousModal(Shell parentShell, String configurationFilePath,
	...
	public synchronized void open() {
		try {
			...
			modelObject = new RiskFactorContinuousObject(true);
