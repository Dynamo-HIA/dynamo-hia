...
public class DiseasePrevalencesModal implements Runnable, DataAndFileContainer {
	...
	public DiseasePrevalencesModal(Shell parentShell, String configurationFilePath,
	...
	public synchronized void open() {
		try {
			...
			diseasePrevalencesGroup.setFormData(helpPanel.getGroup(), buttonPanel);
			shell.pack();
