...
public class OverallDALYWeightsModal implements Runnable, DataAndFileContainer {
	...
	public OverallDALYWeightsModal(Shell parentShell, String configurationFilePath,
	...
	public synchronized void open() {
		try {
			...
			overallDALYWeightsGroup.setFormData(helpPanel.getGroup(), buttonPanel);
			shell.pack();
