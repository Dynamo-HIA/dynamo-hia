...
public class OverallMortalityModal implements Runnable, DataAndFileContainer {
	...
	public OverallMortalityModal(Shell parentShell, String configurationFilePath,
	...
	public synchronized void open() {
		try {
			...
			overallMortalityGroup.setFormData(helpPanel.getGroup(), buttonPanel);
			shell.pack();
