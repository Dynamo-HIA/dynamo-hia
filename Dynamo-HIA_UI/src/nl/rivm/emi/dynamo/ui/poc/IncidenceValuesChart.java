 ...
 */
public class IncidenceValuesChart
{
     ...
     * @param args  ignored.
     */
    public static ChartComposite generate(Composite parent) {
	...
	static public void handlePlacementInGroup(Composite myComposite,
			Text neighbourTop) {
		FormData fData = new FormData();
		fData.top = new FormAttachment(neighbourTop, 5);
		fData.bottom = new FormAttachment(100, -2);
		fData.left = new FormAttachment(100, -152);
		fData.right = new FormAttachment(100, -2);
		myComposite.setLayoutData(fData);
	}
    /**
     * Creates a chart.
     * 
