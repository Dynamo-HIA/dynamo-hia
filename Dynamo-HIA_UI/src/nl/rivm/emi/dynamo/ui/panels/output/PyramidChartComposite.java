 ...
 */
public class PyramidChartComposite extends ChartComposite implements ChartChangeListener,
                                                         ...
                                                         Printable
{
     ...
     */
    public PyramidChartComposite(Composite comp, int style) {
        this(comp, 
                style,
                null,
                DEFAULT_WIDTH,
     ...
     */
    public PyramidChartComposite(Composite comp, int style, JFreeChart chart) {
        this( 
                comp, 
                style,
                chart,
     ...
     *                  enabled for the chart.
     */
    public PyramidChartComposite(Composite comp, 
            int style,
            ...
            public void handleEvent (Event event) {
                switch (event.type) {
                    case SWT.MouseDown:
                        ...
                        /* volgende 2 regels zelf bedacht omdat event in tweede regel niet werkte */
                        MouseEvent event2=new MouseEvent(event);
                        java.awt.event.MouseEvent mouseEvent = SWTUtils.toAwtMouseEvent( event2)  ; 
