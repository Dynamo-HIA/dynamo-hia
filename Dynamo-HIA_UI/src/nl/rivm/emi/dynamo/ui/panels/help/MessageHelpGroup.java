...
public class MessageHelpGroup{
	Group theGroup = null;
	String windowHelp = "Uninitialized";
	String fieldHelp[] = {"Uninitialized1","Uninitialized2"};

	public MessageHelpGroup(Shell shell, Composite buttonPane) {
