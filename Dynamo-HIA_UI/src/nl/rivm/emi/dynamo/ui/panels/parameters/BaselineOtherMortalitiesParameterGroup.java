...
import nl.rivm.emi.dynamo.ui.panels.ValueParameterDataPanel;
...
public class BaselineOtherMortalitiesParameterGroup {
	final Group theGroup;

	public BaselineOtherMortalitiesParameterGroup(Composite parent,
