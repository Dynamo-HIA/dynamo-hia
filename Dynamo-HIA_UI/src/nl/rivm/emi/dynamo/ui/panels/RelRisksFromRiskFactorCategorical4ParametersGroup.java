...
public class RelRisksFromRiskFactorCategorical4ParametersGroup {
	Group theGroup;

	public RelRisksFromRiskFactorCategorical4ParametersGroup(Shell shell,
		...
		RelRisksFromRiskFactorCategoricalBaseZeroParameterGroup parameterGroup = new RelRisksFromRiskFactorCategoricalBaseZeroParameterGroup(
