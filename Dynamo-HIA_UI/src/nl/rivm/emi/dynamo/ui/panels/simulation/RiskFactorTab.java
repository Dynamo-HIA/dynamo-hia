...
public class RiskFactorTab  {
	...
	public void makeIt(){
		...
		riskFactorSelectionGroup.handlePlacementInContainer();		
		
		RiskFactorResultGroup riskFactorResultGroup =
			new RiskFactorResultGroup(this.plotComposite,
					selectedNode, helpGroup);
		riskFactorResultGroup.putNextInContainer(riskFactorSelectionGroup.group, 30);
		//riskFactorResultGroup.handlePlacementInContainer();
