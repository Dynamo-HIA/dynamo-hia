...
public class MortalityDefinitionsDataPanel extends Composite /*
	...
	public MortalityDefinitionsDataPanel(Composite parent, Text topNeighbour,
		...
		unitLabel.setText("Unit: xxxxxxxxxxxxxxx");
		unitTypeModifyListener.registerLabel(unitLabel);
		...
		maleUnitLabel.setText("Unit: xxxxxxxxxxxxxxx");
		unitTypeModifyListener.registerLabel(maleUnitLabel);
