...
public class BaselineOtherMortalitiesGroup {
	final Group theGroup;

	public BaselineOtherMortalitiesGroup(Shell shell, TypedHashMap<?> lotsOfData,
		...
		BaselineOtherMortalitiesParameterGroup parameterGroup = new BaselineOtherMortalitiesParameterGroup(
