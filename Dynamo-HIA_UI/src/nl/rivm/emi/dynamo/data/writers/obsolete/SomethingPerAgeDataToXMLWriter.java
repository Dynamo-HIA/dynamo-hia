...
public class SomethingPerAgeDataToXMLWriter {
	static private Log log = LogFactory
			.getLog("nl.rivm.emi.dynamo.data.factories.IntegerPerAgeDataFromXMLFactory");

	public static void write (AgeSteppedContainer<BiGenderSteppedContainer<IObservable>> lotsOfData, File configurationFile) {
		XMLConfiguration configurationForFile;
		try {
				configurationForFile = new XMLConfiguration(configurationFile);
			configurationForFile.setRootElementName("age_gender_steppeddata");
			configurationForFile.save();
