...
import nl.rivm.emi.dynamo.data.types.atomic.AtomicTypeEnum;
...
public class IncidencesFactory implements IObjectFromXMLFactory<IncidencesObject> {
	...
	/**
	 * Precondition is that a dispatcher has chosen this factory based on the root-tagname.
	 */
	public IncidencesObject manufactureFromFlatXML(
...
//			.getFirstChild();
//			NodeList rootChildren = firstChild.getChildNodes();
//			firstChild.
...
//	}
	...
	private IncidencesObject handleRootChild(
			ConfigurationNode rootChild, IncidencesObject ageMap)
			throws ConfigurationException {
...
//		Object rootChildValueObject = rootChild.getValue();
	...
	public IncidencesObject constructAllZeroesModel() {
		...
		AtomicTypesSingleton atomicTypesSingleton = AtomicTypesSingleton.getInstance();
