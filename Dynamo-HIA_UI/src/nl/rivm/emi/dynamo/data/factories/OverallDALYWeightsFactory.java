...
public class OverallDALYWeightsFactory extends AgnosticFactory {
	...
	public TypedHashMap<Age> manufactureObservable(File configurationFile,
		...
		OverallDALYWeightsObject result = new OverallDALYWeightsObject(
				manufacturedMap);
		return result;
	}
	...
	private OverallDALYWeightsObject manufactureDefault(boolean makeObservable)
			throws ConfigurationException {
		log.debug("Starting manufacture.");
