...
public class TransitionDriftNettoFactoryImplementation extends AgnosticGroupFactory implements
		RootLevelFactory {
	protected Log log = LogFactory.getLog(this.getClass().getName());

	FileControlEnum myEnum = FileControlEnum.TRANSITIONDRIFT_NETTO;
	...
	public TransitionDriftNettoObject manufacture(File configurationFile,
		...
		LinkedHashMap<String, Object> modelMap = super.manufacture(configurationFile,false,
				rootNodeName);
		return new TransitionDriftNettoObject(modelMap);
	}

	@Override
	public TransitionDriftNettoObject manufactureDefault()
			throws nl.rivm.emi.dynamo.exceptions.DynamoConfigurationException {
		LinkedHashMap<String, Object> modelMap = super.manufactureDefault(myEnum);
		return new TransitionDriftNettoObject(modelMap);
	}

	@Override
	public TransitionDriftNettoObject manufactureObservable(
