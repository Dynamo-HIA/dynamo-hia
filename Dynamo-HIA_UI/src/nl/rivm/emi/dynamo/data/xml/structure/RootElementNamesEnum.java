...
/* Estimated parameters. */
	...
	ALFAS(new Alphas(),  StandardTreeNodeLabelsEnum.PARAMETERS.getNodeLabel(), null, StandardTreeNodeLabelsEnum.SIMULATIONS.getNodeLabel()), //
	ALPHAS4P(new Alphas4Parameters(),  StandardTreeNodeLabelsEnum.PARAMETERS.getNodeLabel(), null, StandardTreeNodeLabelsEnum.SIMULATIONS.getNodeLabel()), //
	
	ALPHASOTHERMORTALITY(new AlphasOtherMortality(),  StandardTreeNodeLabelsEnum.PARAMETERS.getNodeLabel(), null, StandardTreeNodeLabelsEnum.SIMULATIONS.getNodeLabel()), //
	RELATIVERISKS_OTHERMORT_BEGIN(new RelativeRisks_OtherMort_Begin(),  StandardTreeNodeLabelsEnum.PARAMETERS.getNodeLabel(), null, StandardTreeNodeLabelsEnum.SIMULATIONS.getNodeLabel()), //
	RELATIVERISKS_OTHERMORT_END(new RelativeRisks_OtherMort_End(),  StandardTreeNodeLabelsEnum.PARAMETERS.getNodeLabel(), null, StandardTreeNodeLabelsEnum.SIMULATIONS.getNodeLabel()), //
	RELATIVERISKS_BEGIN(new RelativeRisks_Begin(),  StandardTreeNodeLabelsEnum.PARAMETERS.getNodeLabel(), null, StandardTreeNodeLabelsEnum.SIMULATIONS.getNodeLabel()), //
	RELATIVERISKS_END(new RelativeRisks_End(),  StandardTreeNodeLabelsEnum.PARAMETERS.getNodeLabel(), null, StandardTreeNodeLabelsEnum.SIMULATIONS.getNodeLabel()), //
