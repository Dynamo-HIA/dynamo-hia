...
public abstract class AbstractFlexibleUpperLimitIntegerType extends FlexibleUpperLimitNumberRangeTypeBase<Integer> implements
	...
	public AbstractFlexibleUpperLimitIntegerType(String elementName, Integer minValue, Integer maxValue) throws ConfigurationException {
