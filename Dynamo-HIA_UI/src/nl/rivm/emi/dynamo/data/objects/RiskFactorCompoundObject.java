...
public class RiskFactorCompoundObject extends XMLHandlingEntryPoint implements
...
//							rootChild);
			...
			durationClassObjectImplementation.manufactureDefault();
		}
		return modelObject;
	}
	...
	public void streamEvents(String value, XMLEventWriter writer, XMLEventFactory eventFactory)
		...
		durationClassObjectImplementation
		.streamEvents(null, writer, eventFactory);
