...
public class RelativeRisksClusterObject  extends TypedHashMap<Age> implements StandardObjectMarker{
	 ...
	 */
		public RelativeRisksClusterObject(TypedHashMap<Age> manufacturedMap) {
