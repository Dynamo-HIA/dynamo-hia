...
public class RunnableRelRiskForDeathCompound_Default_Manufacturing implements Runnable {
	...
	public void run() {
		...
		try {
			...
			AgnosticFactory theFactory = FactoryProvider.getRelevantFactoryByRootNodeName(rootElementName);
