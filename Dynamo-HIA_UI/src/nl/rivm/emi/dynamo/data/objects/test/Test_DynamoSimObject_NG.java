...
public class Test_DynamoSimObject_NG {
	...
	public void nonObservable() {
		String configurationFilePath = "data" + File.separator + "development"
				+ File.separator + "growingsimulation.xml";
	...
	@Test
	public void nonObservable_HasNewbornsErr() {
		String configurationFilePath = "data" + File.separator + "development"
				+ File.separator + "growingsimulation_newbornserr.xml";
		File configurationFile = new File(configurationFilePath);
		String outputFilePath = "data" + File.separator + "development"
				+ File.separator + "growingsimulation_output.xml";
		File outputFile = new File(outputFilePath);
