...
/**
 * Initial Characteristics configuration before the tests.
 * @author mondeelr
 *
 */
public class Test01_00 {
	Log log = LogFactory.getLog(getClass().getName());

	String existingFileName_MultiChar = "unittestdata/iteration2/test/charconf01_00.xml";

	String multiChar_Report_FileName = "unittestdata/iteration2/test/charconf01_00.txt";
