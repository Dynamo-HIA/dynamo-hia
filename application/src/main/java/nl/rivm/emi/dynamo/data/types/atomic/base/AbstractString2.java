...
/**
 * Version on plain base-class for String type configuration items where spaces are allowed.
 */
//gemaakt als alternatief voor AbstractString, maar dat werkt niet

public class AbstractString2 extends AtomicTypeBase<String> {
	...
	final public Pattern matchPattern =Pattern.compile("^[\\w_\\s]*$");;
	 ...
	 */
	public AbstractString2(String myElementName) {
