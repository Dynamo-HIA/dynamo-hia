...
public class RelativeRisksClusterOneAgeAndSexParameterGroup {
	/**
...
//	}
	...
	public RelativeRisksClusterOneAgeAndSexParameterGroup(Composite parent,
		...
		theGroup.setLayout(formLayout);
		 Composite parameterDataPanel = new RelativeRisksClusterParameterPanel(
