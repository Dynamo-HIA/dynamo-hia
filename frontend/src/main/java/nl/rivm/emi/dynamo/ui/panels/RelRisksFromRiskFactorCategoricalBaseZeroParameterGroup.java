...
public class RelRisksFromRiskFactorCategoricalBaseZeroParameterGroup {
	Group theGroup;

	public RelRisksFromRiskFactorCategoricalBaseZeroParameterGroup(Composite parent,
		...
		Composite parameterDataPanel = new ValuePerClassBaseZeroParameterDataPanel(
