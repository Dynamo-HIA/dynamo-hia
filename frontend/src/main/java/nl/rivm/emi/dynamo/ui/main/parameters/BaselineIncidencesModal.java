...
import nl.rivm.emi.dynamo.ui.panels.parameters.BaselineIncidencesGroup;
 ...
 *
 */
public class BaselineIncidencesModal extends AbstractDataModal {
	 ...
	 * @param selectedNode
	 */
	public BaselineIncidencesModal(Shell parentShell, String dataFilePath,
	...
	public synchronized void openModal() throws ConfigurationException, DynamoInconsistentDataException {
			...
			BaselineIncidencesGroup baselineFatalIncidencesGroup = new BaselineIncidencesGroup(
