 ...
 *
 */
public class BaselineOtherMortalitiesModal extends AbstractDataModal {
	 ...
	 * @param selectedNode
	 */
	public BaselineOtherMortalitiesModal(Shell parentShell, String dataFilePath,
	...
	protected String createCaption(BaseNode selectedNode2) {
		return "Baseline other mortalities";
	}
	...
	public synchronized void openModal() throws ConfigurationException, DynamoInconsistentDataException {
			...
			BaselineOtherMortalitiesGroup attributableMortalityGroup = new BaselineOtherMortalitiesGroup(
