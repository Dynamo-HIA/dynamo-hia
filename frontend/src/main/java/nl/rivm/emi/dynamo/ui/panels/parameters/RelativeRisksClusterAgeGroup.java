...
public class RelativeRisksClusterAgeGroup extends Composite {
	...
	RelativeRisksClusterOneAgeAndSexParameterGroup[] transMatGroups;
	int currentAge = 0;
	boolean grow = false;
	...
	public RelativeRisksClusterAgeGroup(Shell parent, int style,
		...
		transMatGroups = new RelativeRisksClusterOneAgeAndSexParameterGroup[maxGender
				- minGender + 1];
	...
	private void refreshTransitionMatrixGroup(Composite parent, int age,
		...
		transMatGroups[gender] = new RelativeRisksClusterOneAgeAndSexParameterGroup(
				parent,
