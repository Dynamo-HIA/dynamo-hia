...
public class Age4TransitionMatrixComboModifyListener implements ModifyListener {
	...
	public Age4TransitionMatrixComboModifyListener(@SuppressWarnings("rawtypes") WritableValue unitTypeWritableValue) {
		super();
