 ...
 *
 */
public class AttributableMortalitiesModal extends AbstractDataModal {
	 ...
	 * @param selectedNode
	 */
	public AttributableMortalitiesModal(Shell parentShell, String dataFilePath,
	...
	public synchronized void openModal() throws ConfigurationException, DynamoInconsistentDataException {
			...
			this.shell.setSize(ModalStatics.defaultWidth42Cols+100, ModalStatics.defaultHeight);
			this.shell.open();
	}
