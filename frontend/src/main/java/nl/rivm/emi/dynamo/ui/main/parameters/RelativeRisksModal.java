...
import nl.rivm.emi.dynamo.ui.panels.parameters.RelativeRisksCategoricalGroup;
 ...
 *
 */
public class RelativeRisksModal extends AbstractDataModal {
	 ...
	 * @param selectedNode
	 */
	public RelativeRisksModal(Shell parentShell, String dataFilePath,
	...
	public synchronized void openModal() throws ConfigurationException, DynamoInconsistentDataException {
			...
			RelativeRisksCategoricalGroup relativeRisksGroup = new RelativeRisksCategoricalGroup(
					this.shell, this.modelObject, this.dataBindingContext,
					this.selectedNode, this.helpPanel);
			relativeRisksGroup.setFormData(this.helpPanel.getGroup(),
					buttonPanel);
			this.shell.pack();
